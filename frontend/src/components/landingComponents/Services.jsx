    ...
    <div  className="row py-5 bg servicesh">
      ...
      <div className="col-sm-10 col-md-10 card1 mx-auto">
        <div className="row py-3">
          <div className="col-sm-4 col-md-4" data-aos="fade-right">
          ...
          <div className="col-sm-4 col-md-4" data-aos="zoom-in-up">
            <div className="card mx-auto shadow-lg p-4 border border-0" data-aos="zoom-in-up">
          ...
          <div className="col-sm-4 col-md-4" data-aos="fade-left">
            <div className="card mx-auto shadow-lg p-4 border border-0">
