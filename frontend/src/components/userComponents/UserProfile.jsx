              ...
              <form onSubmit={handleSubmit((d)=>handleRegister(d))}>
                <div className="row g-3">
                  <div className='row'>
                      <div className="col-sm-4 col-md-4"></div>
                        <div className="col-sm-4 col-md-4">
                          <img src={`http://127.0.0.1:9000/img/${userDetails?.profile}`} alt="not found" width="150px" height="150px" className=' rounded-circle border border-4 border-dark' />
                        </div>
                        <div className="col-sm-4 col-md-4"></div>
                  </div>
                  ...
                  <div className="text-center mt-4">
                    <div className="row">
                      <div className="col-sm-4  col-md-4"></div>
                    <div className="col-sm-4 col-md-4"><input type="submit" className="btn px-5 btn-login m-0" value="Update" /></div>
                    <div className="col-sm-4 col-md-4"></div>
                    </div>
                  </div>
                </div>
